...
- **物理键盘对齐 & 输入法一键切换**：严格区分左右 Shift，并通过底部中英文键发送硬件级 `VK_RSHIFT` 脉冲，快速切换微软拼音、搜狗等输入法的中英文状态。
...
- **中英文一键切换**：点击底部的 `英` / `中` 键，向当前输入法发送右 Shift 脉冲并刷新输入法状态。
